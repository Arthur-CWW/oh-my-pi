...
2. You need to threat-model unofficial API usage and explain to stakeholders/users why client impersonation, leaked bearers, or private endpoints pose critical stability, account, terms-of-service, and security risks.
...
3. **Threat Modeling & Risk Analysis**:
   - Assess security and operational risks of unofficial client tooling (e.g., potential token leakage, rate-limiting signatures, account bans, enforcement actions).
...
## Forbidden Tasks (Operating Boundaries)

The following activities are out of scope for this skill and must not be requested or implemented:
