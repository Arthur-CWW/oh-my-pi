# Rewriting Bun in Rust (archived)

- Canonical URL: https://bun.com/blog/bun-in-rust.md
- Retrieved: 2026-07-16
- Source type: publisher markdown (first-party blog)
- Purpose: reference methodology for massively-parallel agent-driven migrations (HR-164 Effect/OTP migration design)
...
{% image src="/images/update-interactive-r.png" caption="it should say oxfmt, not oxfmtr" /%}
...
<blockquote class="twitter-tweet"><p lang="zxx" dir="ltr"><a href="https://t.co/RQiMNMNo8C">pic.twitter.com/RQiMNMNo8C</a></p>&mdash; Bun (@bunjavascript) <a href="https://x.com/bunjavascript/status/2056510566018203971?ref_src=twsrc%5Etfw">May 18, 2026</a></blockquote> <script async src="https://platform.x.com/widgets.js" charset="utf-8"></script>
...
![Claude Code startup time from production telemetry (Linux p50): v2.1.179 at 517ms vs v2.1.181, the first release on Rust Bun, at 464ms — 10% faster](/images/claude-code-rust-bun-startup.png)
