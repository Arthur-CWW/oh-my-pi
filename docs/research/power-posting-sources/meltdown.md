...
**Source URL:** http://www.ccru.net/swarm1/1_melt.htm
**Retrieved:** 2026-07-08
**Content type:** text/html (CCRU "swarm1" archive; iso-8859-1)
**Canonical print reference:** Nick Land, *Meltdown* (1994), collected in *Fanged Noumena: Collected Writings 1987–2007*, Urbanomic/Sequence Press, 2011, pp. 441–459.

## Structural note (5 lines)
1. **Form:** ~3,900-word prose-poem / theory-fiction; not chaptered — it advances as ~30 aphoristic blocks each opened by the CCRU swarm bullet `[[ ]]` (a section/breath marker), several bearing embedded titles: *Machinic Synthesis*, *Heat*, *The Turing Test*, *The Superiority of Far Eastern Marxism*, *Hot revolution*, *Biohazard*, *Bugs in the system*, *K-tactics*.
2. **Famous opening:** "The story goes like this: Earth is captured by a technocapital singularity as renaissance rationalitization and oceanic navigation lock into commoditization take-off." — followed by the staccato prophecy fragments culminating in "Neo-China arrives from the future." / "Nanospasm."
3. **Arc:** cold-open prophecy → schizoanalysis/Deleuze-Guattari machinics → capital as autonomizing nihilist vortex → AI / Turing-cops → "accelerate the process" (the DG citation that names accelerationism) → nano/bacterial biohazard → cyberpunk LA hellscape → K-tactics against the Human Security System, ending "To be continued."
4. **Signature refrains for narration:** "Nothing human makes it out of the near-future."; "Neo-China arrives from the future."; "It's war."; "Can what is playing you make it to level-2?"; "Tomorrow can take care of itself."
5. **Transcription fidelity:** verbatim from the CCRU page. The source's iso-8859-1 `&aelig;` (rendered "æ") is a mojibake standing in for an **opening single quote** and has been normalized to `'` (confirmed against the *Fanged Noumena* and *A Nick Land Reader* renderings). All genuine CCRU-era typos are preserved verbatim — e.g. "rationalitization", "explosiion", "machinc", "sucessively", "competitve", "cybercaptial", "techoscientific", "artifical", "forgeign", "inititiating", "teh videodrome", "crytographic", "incapicitate", "definciency", "acessible", "it s own".
...
The investment-income class advantages itself of commodity dynamics, but only by conforming to the axiomatic of neutral profit maximization; facilitating the dehumanization of wealth and the side-lining of non-productive consumption. The cyberpunk circuitry of self-organizing planetary commoditronics escaped nominal bourgeois control in the late nineteenth century, provoking technocratic-corporatist (i.e. fascist / 'social democratic') political cultures in allergic reaction. The government structures of both eastern and western metropolitan centres consolidated themselves as population policing Medico-Military Complexes with neomercantilist forgeign policy orientations. All such formations slid into irreversible crisis in the 1980s.
...
[[ ]]
Nanocataclysm begins as fictional science. 'Our ability to arrange atoms lies at the foundation of technology' [Dx1:3] Drexler notes, although this has traditionally involved manipulating them in 'unruly herds' [Dx1:4]. The precision engineering of atomic assemblies will dispense with such crude methods, inititiating the age of molecular machinery, 'the greatest technological breakthrough in history' [Dx1: 4]. Since neither logos nor history have the slightest chance of surviving such a transition this description is substantially misleading.
