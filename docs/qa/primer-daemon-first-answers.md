...
- Query path: `packages/primer-daemon` (`bun run primer <cmd>` from repo root).
...
- Gate at time of proof: `bun run primer-daemon:typecheck` clean; `bun run primer-daemon:test` 19/19 across 7 files.

## Q1 — "What have I been reading about Nick Land and Meltdown?"

Rerun: `bun run primer ask "what have I been reading about Nick Land and Meltdown?" --limit 12`
...
Rerun: `bun run primer ask "what have I been reading about HSK and Chinese learning?" --limit 10`
...
Rerun: `bun run primer ask "what have I been reading about spaced repetition and flashcards?" --limit 10`
...
Rerun of the records: `bun run primer note list && bun run primer card list`
