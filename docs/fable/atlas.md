...
| Harness | `vendor/oh-my-pi/`, `packages/{web-access,dynamic-workflows,omp-perf-explorer,control-plane,agent-mux}/`, `.omp/`, `skills/` | [`harness-brief.md`](harness-brief.md), [`harness-slimming.md`](harness-slimming.md), [`omp-runtime-map.md`](omp-runtime-map.md) (derived code/monitoring map), [`session-lifecycle-commands.md`](session-lifecycle-commands.md) (continue/fork/tangent/converge/commission authority), [`federated-control-plane.md`](federated-control-plane.md) (workspace/control-plane architecture), [`context-bearing-delegation.md`](context-bearing-delegation.md) (parent-context retrieval/delegation doctrine), [`friction-triage-contract.md`](friction-triage-contract.md) (closed-loop report contract), [`harness-research-register.md`](harness-research-register.md) (deferred research/watchlist) |

Current harness execution view: [`docs/state/harness-priority-board.md`](../state/harness-priority-board.md) (derived Now/Next/Blocked/Done projection; request/design registers remain authority).
