...
- Model routing for orchestrators and workers (Arthur, 2026-07-06): GPT-5.5 is acceptable as an orchestrator or worker when the task is well-constrained and needs no creativity. Fable 5 at MEDIUM thinking is preferred for anything requiring creativity — persona/prose writing, motion and taste design, prompt crafting, character work. Constrained implementation slices route to gpt/kimi lanes; creative packets route to Fable-class models.
- **Fable 5 conservation (Arthur, 2026-07-06, URGENT):** NEVER launch Fable 5 at high thinking — medium only. The Fable 5 quota is ~24% remaining and the model is gone forever after Wednesday (2026-07-08). Spend it exclusively on creative work at medium; everything constrained goes to gpt/kimi lanes. When in doubt, don't burn Fable.
