...
- **Fable 5 conservation (Arthur, 2026-07-06):** never launch Fable 5 at high thinking — medium only, and only for creative work. The lane runs on finite, non-renewing quota nearing sunset; constrained tasks go to gpt/kimi lanes. When in doubt, don't burn Fable.
