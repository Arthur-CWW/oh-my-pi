...
Use the fast packet protocol from @docs/plans/jimeng-fast-contract-extraction.md:
...
4. Run or improve `contract-infer` to generate Effect Schema/client/CLI/test/registry drafts from saved samples.
5. Hand-tighten only relied-on paths, flags, redaction, and errors.
