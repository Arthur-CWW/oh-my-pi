...
- refreshed inventory proof: `data/jimeng-lab/proof-20260611-static-inventory-media-helper-blockers/` reports `implemented=61`, `unknown=98`, `partial=6`, `dry_run_only=5`, and `blocked=78`
