...
| Infinite canvas | `/mweb/v1/infinite_canvas/list_project`, `/mweb/v1/infinite_canvas/project_detail`, and `/mweb/v1/infinite_canvas/v1/get_canvas_custom_ratio` are implemented as no-spend `infinite-canvas`; `/mweb/v1/infinite_canvas/create_project`, `/mweb/v1/infinite_canvas/conversation`, `/mweb/v1/infinite_canvas/edit`, `/mweb/v1/infinite_canvas/resume`, `/mweb/v1/infinite_canvas/stop_stream`, `/mweb/v1/infinite_canvas/v1/fetch_snapshot`, `/mweb/v1/infinite_canvas/v1/submit_changeset`, and `/mweb/v1/infinite_canvas/v1/fetch_changeset` remain capture/disposable-fixture targets |
