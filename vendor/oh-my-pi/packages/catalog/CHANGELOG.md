...
- Codex context-window metadata can label vendored Codex upstream defaults and explicit user overrides in addition to provider endpoint and catalog fallback sources.
