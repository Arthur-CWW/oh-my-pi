...
export const commands: CommandEntry[] = [
	...
	{ name: "automations", load: () => import("./task/automations-command").then(m => m.default) },
	...
	{ name: "fleet", load: () => import("./commands/fleet").then(m => m.default) },
	{ name: "friction", load: () => import("./commands/friction").then(m => m.default) },
	...
	{ name: "refusals", load: () => import("./commands/refusals").then(m => m.default) },
