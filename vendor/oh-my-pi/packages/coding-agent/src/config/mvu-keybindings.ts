...
const selectorGlobalBindings: readonly KeymapBinding[] = [
	...
	resolved("app.interrupt", "Browse", "list", ["ctrl+c"]),
	resolved("ui.dismiss", "Filter", "list"),
	resolved("app.interrupt", "Filter", "list", ["ctrl+c"]),
	resolved("ui.dismiss", "PreviewFocus", "preview"),
	resolved("app.interrupt", "PreviewFocus", "preview", ["ctrl+c"]),
	resolved("ui.dismiss", "Confirm", "preview"),
	resolved("app.interrupt", "Confirm", "preview", ["ctrl+c"]),
