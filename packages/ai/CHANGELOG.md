...
- Added structured detection for provider classifier refusals carrying a category so callers can keep terminal context failures out of transient retry paths.
