...
test("ledger migration and fixture rows cover every row family", async () => {
  ...
  try {
    ...
    expect(tableNames).toEqual(["agent_timeline_events", "artifacts", "benchmark_catalog", "benchmark_saturation_assessments", "branches", "commercial_facts", "commits", "evaluation_measurements", "evaluation_run_participants", "evaluation_runs", "events", "evidence_sources", "lane_state", "metric_definitions", "model_calls", "packets", "provider_calls", "route_advisors", "route_candidates", "route_event_artifacts", "route_resolutions", "routing_observations", "sessions", "turns"])
