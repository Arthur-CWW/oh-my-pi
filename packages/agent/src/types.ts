...
export interface AgentLoopConfig extends SimpleStreamOptions {
	...
	/**
	 * Admits one host-owned queued input as one or more adjacent messages at a
	 * settled tool-batch boundary when in-memory steering is empty. The loop
	 * never polls, caches, or invokes this hook at terminal follow-up boundaries.
	 */
