...
const KEEP_GAP_AUDIT_BY_ENDPOINT: Record<string, JimengDiscoveryEndpointAudit> = {
  "/mweb/v1/aigc_draft/generate": {
    ...
    nextProbe: "Passively capture a current frontend submit for lip-sync, end-frame, multi-frame, or omni-reference generation, then run the matching text2video-compare, lip-sync-compare, or request-plan-compare before any approval-gated live submit.",
  },
  "/mweb/v1/execute_generate_audit": {
    evidence: [
...
const KNOWN_ENDPOINTS: JimengDiscoveryKnownEndpoint[] = [
  known("/mweb/v1/aigc_draft/generate", "partial", "text2image-plan/text2image-compare/text2video-plan/omni-video-plan/text2video-compare/text2video/image2video/frames2video/lip-sync", "Unified generation submit; direct image/video, first/end-frame, and Seedance omni-reference request builders are dry-run covered; live lip-sync/end-frame/omni-reference still require capture compare or approval-gated submit."),
