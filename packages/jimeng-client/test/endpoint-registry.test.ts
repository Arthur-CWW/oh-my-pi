...
describe("Jimeng endpoint registry", () => {
  ...
  test("summarizes triage keep-family coverage from registry statuses", () => {
    ...
    expect(markdown).toContain("- `/mweb/v1/aigc_draft/generate` - partial command=text2image-plan/text2image-compare/text2video-plan/omni-video-plan/text2video-compare/text2video/image2video/frames2video/lip-sync")
