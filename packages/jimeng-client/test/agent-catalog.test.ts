  ...
  test("fetches and summarizes skills and model options without signed URLs", async () => {
    ...
    expect(summary).toMatchObject({
      ...
      config: {
        ...
        video_model_count: 1,
        high_value_flags: {
          image_control_feats: ["byte_edit", "canny", "depth", "pose", "support_subject"],
        ...
        model_list: [
          {
            ...
            model_tip: "指令响应更精准",
            feats: ["t2i", "byte_edit", "support_subject", "pose", "canny", "depth"],
            blend_enable: { pose: true, canny: true, depth: false },
